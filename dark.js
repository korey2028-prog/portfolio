...
(function () {
  ...
  const i18n = {
    zh: {
      ...
      'capabilities.h': '不只会做 Demo，<br>我把问题推进到能交付的形态。',
      ...
      'proj2.title': '身体 OS',
      'proj2.desc': '一个用 Pearl 因果框架建模"身体"的私人系统。9 个机制模型 + 3 个操作协议，处理"睡了很久还是没精神"这一类问题：从中介变量入手，找到可以替换的环节，减少补救动作。',
      'proj2.mock.n1': '睡眠时长',
      'proj2.mock.n2': '作息节律',
      'proj2.mock.n3': '恢复质量',
      'proj2.mock.n4': '日间精力',
      'proj3.title': 'AI 协作工作流',
      'proj3.desc': 'Claude Code 与 Codex 双平台 Skill 系统。手机 Gemini 做轻量捕获，桌面 Claude 做深加工，每个领域都有自己的 Skill 入口。目标是把 Prompt 封装成可被调用的产品。',
      'notes.h': '几条还在用的观察。',
